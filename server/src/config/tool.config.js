...
export const availableTools = [
  ...
  },
  {
    ...
    name: "Code Execution",
    description:
      "Generate and execute Python code to perform calculation, solve problem, or provide accurate information.",
...
export function getEnabledTools() {
  ...
  try {
    ...
    console.log(chalk.red(`[ERROR] Failed to initialize tools`), error.message);
    console.log(
